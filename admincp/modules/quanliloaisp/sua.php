...
?>
<form action="modules/quanliloaisp/xuli.php?id=<?php echo $dong['id_loaisp']?>" method="post" enctype="multipart/form-data">
<table width="100%" border="1">
    ...
    <tr>
        <td colspan="2"><div align="center">
                <input type="submit" name="sua" id="sua" value="sua"/></div></td>
    </tr>
</table>
</form>   
